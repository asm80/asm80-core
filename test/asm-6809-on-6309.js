import { H6309 as M6809 } from "../cpu/h6309.js";
import { Parser } from "../expression-parser.js";

QUnit.config.hidepassed = true;

QUnit.module("ASM M6809 (on H6309)");


QUnit.test("Namespace", function () {
  QUnit.assert.notEqual(M6809, null, "H6309 (as M6809) is defined");
  QUnit.assert.equal(typeof M6809, "object", "H6309 is an object");
  QUnit.assert.equal(
    typeof M6809.parseOpcode,
    "function",
    "H6309.parseOpcode defined"
  );
});

QUnit.module("6809 Adhoc tests (on H6309)");
